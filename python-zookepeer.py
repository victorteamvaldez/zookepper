...
while(True):
	...
	try:
		print(animals[int(habitat)], end='\n')

	except IndexError:
		print('The animal index is not in the list', end='\n')
		continue

	except ValueError:
		print('Apparently your input is invalid, try with a number between 0-5 or Exit', end='\n')
		continue